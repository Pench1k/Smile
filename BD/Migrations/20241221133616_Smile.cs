    ...
    public partial class Smile : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stomatology", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaborNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Education = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateOfEmployment = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StomatologyId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Workers_Stomatology_StomatologyId",
                        column: x => x.StomatologyId,
                        principalTable: "Stomatology",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Doctor_Workers_WorkersId",
            ...
            migrationBuilder.CreateTable(
                name: "WorkingHouseDoctor",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkingHouseId = table.Column<int>(type: "int", nullable: true),
                    WorkingHoursId = table.Column<int>(type: "int", nullable: true),
                    DoctorId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkingHouseDoctor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkingHouseDoctor_Doctor_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctor",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkingHouseDoctor_WorkingHours_WorkingHoursId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkingHouseDoctorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reception_WorkingHouseDoctor_WorkingHouseDoctorId",
                        column: x => x.WorkingHouseDoctorId,
                        principalTable: "WorkingHouseDoctor",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reception_WorkingHouseDoctorId",
                table: "Reception",
                column: "WorkingHouseDoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Workers_StomatologyId",
                table: "Workers",
                column: "StomatologyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHouseDoctor_DoctorId",
                table: "WorkingHouseDoctor",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkingHouseDoctor_WorkingHoursId",
                table: "WorkingHouseDoctor",
